...
import com.example.newsappwithcompose.presentation.Dimans
...
fun ArticleCardShimmerEffect(modifier: Modifier = Modifier) {
    Row(
        ...
        Column(
            ...
            modifier = Modifier
                .padding(horizontal = Dimans.ExtraSmallPadding)
                .height(Dimans.ArticleCardSize)
        ) {
            Box(
                modifier = Modifier
                    .fillMaxWidth()
